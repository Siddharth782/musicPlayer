...
const Details = (props) => {
    ...
    const { currentSound, setCurrentSound, setCurrentTrack, currentTrack, setIsPlaying, setIsLoading, setPlaylistName, setPlaylist, setCurrentIndex, playlist } = useContext(PlayerContext)
    ...
    function getPlaylistTracks() {
        ...
        try {
            fetch(`${BASE_URL}/playlists/${id}/tracks`, dataParameters)
                .then((res) => res.json())
    ...
    function getPlaylist() {
        ...
        try {
            fetch(`${BASE_URL}/playlists/${id}`, dataParameters)
                .then((res) => res.json())
    ...
    function getSavedTracks() {
        ...
        try {
            fetch(`${BASE_URL}/me/tracks?limit=50`, dataParameters)
                .then((res) => res.json())
    ...
    function getArtistsTracks() {
        ...
        try {
            fetch(`${BASE_URL}/artists/${id}/top-tracks?country=IN&limit=15`, dataParameters)
                .then((res) => res.json())
                .then((res) => { setArtistTracks(res?.tracks), setLoaderVisible(false) })
            fetch(`${BASE_URL}/artists/${id}/albums?country=IN&limit=15`, dataParameters)
                .then((res) => res.json())
    ...
    function getSingleTrack() {
        try {
            fetch(`${BASE_URL}/tracks/${id}`, dataParameters)
                .then((res) => res.json())
    ...
    function getAlbumTracks() {
        try {
            fetch(`${BASE_URL}/albums/${id}/tracks`, dataParameters)
                .then((res) => res.json())
    ...
    async function addToLikedSongs({ songUri }) {
        ...
        try {
            ...
            let addToLiked = await fetch(`${BASE_URL}/me/tracks`, addParameters)
