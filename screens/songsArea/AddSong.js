...
const AddSong = (props) => {
    ...
    function getRecommendations() {
        try {
            fetch(`https://api.spotify.com/v1/recommendations?seed_genres=rock,mood,workout`, dataParameters)
                .then((res) => res.json())
    ...
    function getRecentlyPlayed() {
        try {
            fetch(`https://api.spotify.com/v1/me/player/recently-played`, dataParameters)
                .then((res) => res.json())
    ...
    async function searchData() {
        ...
        try {
            ...
            let resTracks = await fetch(`https://api.spotify.com/v1/search?q=${searchValue}&type=track&limit=10`, searchParameters)
    ...
    async function addTrackToPlaylist({ songUri }) {
        ...
        try {
            let addTrack = await fetch(`https://api.spotify.com/v1/playlists/${playListId}/tracks`, addingParameters)
